...
int main (int argc, char *argv[])
{
	...
	n2->SetPosition(0,100,0);
    n3->SetPosition(0,500,0);
    n4->SetPosition(100,500,0);
    ...
    Ptr<PLC_Outlet> o3 = CreateObject<PLC_Outlet> (n3);
	Ptr<PLC_Outlet> o4 = CreateObject<PLC_Outlet> (n4);
	...
	Simulator::Schedule(Seconds(1), &PLC_NetDevice::Send, devMap["Node2"], p, devMap["Node4"]->GetAddress(), 0);
